...
case menu_input
when 1
    features = ["1: Open Air Staying. Price:$23/day","2: Deluxe Indoor Stay. Price:$30/day", "Go back to memu"]
    ...
    if selection == "1: Open Air Staying. Price:$23/day"
        ...
        features_outdoor = ["Two meals per day","Play time with doggy friends","Jackets may be required depending on weather conditions, can be hired at time of check-in"]
